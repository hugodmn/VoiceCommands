...
from VoiceCommands.LSTM.model.model import LSTM
...
class LSTMInference:
    def __init__(self,device, class_mapping:Tuple[int]=[0, 1]) -> None:
        ...
        self.state_dict = torch.load("VoiceCommands/LSTM/model/state_dict_model.pt",map_location=torch.device(device))
